...
def check_lu_solver(init_batch_size, batch_size, rows, cols, fill, verbose=False):
    ...
    slv = CusolverLUSolver(init_batch_size, AtA_cols, AtA_rowPtr, AtA_colInd)
...
def test_lu_solver_1():
    check_lu_solver(init_batch_size=5, batch_size=5, rows=50, cols=30, fill=0.2)


def test_lu_solver_2():
    check_lu_solver(init_batch_size=5, batch_size=5, rows=150, cols=60, fill=0.2)


def test_lu_solver_3():
    check_lu_solver(init_batch_size=10, batch_size=10, rows=300, cols=90, fill=0.2)


def test_lu_solver_4():
    check_lu_solver(init_batch_size=5, batch_size=5, rows=50, cols=30, fill=0.1)


def test_lu_solver_5():
    check_lu_solver(init_batch_size=5, batch_size=5, rows=150, cols=60, fill=0.1)


def test_lu_solver_6():
    check_lu_solver(init_batch_size=10, batch_size=10, rows=300, cols=90, fill=0.1)
...
#     check_lu_solver(init_batch_size=10, batch_size=5, rows=150, cols=60, fill=0.2)
