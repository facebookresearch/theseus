...
from theseus.geometry.functions.lie_group_function import (
    LieGroupAdjoint,
    LieGroupCompose,
    LieGroupExpMap,
    LieGroupFunction,
...
class SO3Project(LieGroupProject):
    @classmethod
...
class SO3LeftProject(LieGroupLeftProject):
    @staticmethod
    def manifold():
        return SO3Function


class SO3RightProject(LieGroupRightProject):
    @staticmethod
    def manifold():
        return SO3Function


class SO3LeftApply(LieGroupLeftApply):
    @staticmethod
    def manifold():
        return SO3Function
    ...
    def forward(cls, ctx, group, matrix, jacobians):
        ...
        return cls.call(group, matrix, jacobians)
...
class SO3RightApply(LieGroupRightApply):
    @staticmethod
    def manifold():
        return SO3Function
...
class SO3Adjoint(LieGroupAdjoint):
    @staticmethod
    def manifold():
        return SO3Function
...
class SO3Inverse(LieGroupInverse):
    @staticmethod
    def manifold():
        return SO3Function
...
class SO3Compose(LieGroupCompose):
    @staticmethod
    def manifold():
        return SO3Function
    ...
    def call(
        ...
        if not SO3Function.check_group_tensor(g0) or not SO3Function.check_group_tensor(
            g1
        ):
            raise ValueError("Invalid data tensor for SO3.")
        if jacobians is not None:
...
class SO3Function(LieGroupFunction):
    ...
    hat = SO3Hat
    inverse = SO3Inverse
    left_apply = SO3LeftApply
    left_project = SO3LeftProject
    project = SO3Project
    right_apply = SO3RightApply
    right_project = SO3RightProject
